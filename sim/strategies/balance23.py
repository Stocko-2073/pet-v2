...
class Balance23:
  ...
  def step(self,action):
    ...
    reward+=self.parametric_gaussian(chest_accel[2],mean=9.8,sigma=1)
    reward+=self.parametric_gaussian(torso_accel[2],mean=9.8,sigma=1)
    reward+=self.parametric_gaussian(left_foot_accel[2],mean=9.8,sigma=1)
    reward+=self.parametric_gaussian(right_foot_accel[2],mean=9.8,sigma=1)
    ...
    reward+=self.parametric_gaussian(chest_accel[0],mean=0,sigma=1)
    reward+=self.parametric_gaussian(torso_accel[0],mean=0,sigma=1)
    reward+=self.parametric_gaussian(left_foot_accel[0],mean=0,sigma=1)
    reward+=self.parametric_gaussian(right_foot_accel[0],mean=0,sigma=1)

    # Apply low Y acceleration reward
    #low_y_accel_reward=self.parametric_gaussian(chest_accel[1],mean=0,sigma=1)
    reward+=self.parametric_gaussian(chest_accel[1],mean=0,sigma=1)
    reward+=self.parametric_gaussian(torso_accel[1],mean=0,sigma=1)
    reward+=self.parametric_gaussian(left_foot_accel[1],mean=0,sigma=1)
    reward+=self.parametric_gaussian(right_foot_accel[1],mean=0,sigma=1)
