...
class PoseMatch1:
  ...
  def step(self,action):
    ...
    # TODO: implement the rest of the rewards...
  ...
  def _check_terminal_conditions(self,joint_pos,chest_accel,torso_accel):
    ...
    # TODO: Implement any terminal conditions
    return False
  ...
  def reset(self):
    ...
    # TODO: add any extra reset characteristics here...
  ...
  def apply_action(self,action):
    # Apply the action
    # TODO: Add any tweaks to the action from the model here...
